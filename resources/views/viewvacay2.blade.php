...
<nav class="navbar navbar-expand-sm navbar-light justify-content-between">
  ...
  <a href="{{url('/')}}">
    ...
    <div class="row">
      ...
      <div class="row">
        <div class="col">
             <ul><h4><strong>Coban Rais Flower Garden</strong></h4></ul>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col">
            ...
            <ul>This attraction features a hillside landscaped with flowers, plus waterfalls and various activities. </ul>

            <ul> Oro-Oro Ombo, Kehutanan, Kec. Batu, Kota Batu, Jawa Timur 65151 </ul>
